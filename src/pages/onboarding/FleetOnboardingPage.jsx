...
import FleetStep1 from '../../components/onboarding/fleet/FleetStep1';
import FleetStep2 from '../../components/onboarding/fleet/FleetStep2';
import FleetStep3 from '../../components/onboarding/fleet/FleetStep3';
...
const FleetOnboardingPage = () => {
  ...
  const handleStep3Submit = async (data) => {
    ...
    // try {
    //   const response = await completeFleetOnboarding(finalData).unwrap();
    //   dispatch(setCredentials({
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="border-l border-gray-300 pl-4">
                <h1 className="text-lg font-bold text-gray-900">Fleet Operator Onboarding</h1>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-8 py-6">
          <div className="flex items-center justify-between mb-2">
            {[
              { num: 1, label: 'Fleet Profile' },
              { num: 2, label: 'Compliance & Telematics' },
