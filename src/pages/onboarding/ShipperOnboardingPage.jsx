...
import ShipperStep3 from '../../components/onboarding/shipper/ShipperStep3';
import ShipperStep4 from '../../components/onboarding/shipper/ShipperStep4';
...
const ShipperOnboardingPage = () => {
  ...
  const handleStep4Submit = async (data) => {
    ...
    // try {
    //   const response = await completeShipperOnboarding(finalData).unwrap();
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div className="border-l border-gray-300 pl-4">
                <h1 className="text-lg font-bold text-gray-900">Shipper Onboarding</h1>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-8 py-6">
          <div className="flex items-center justify-between mb-2">
            {[
              { num: 1, label: 'Business Classification' },
              { num: 2, label: 'Cargo & Insurance' },
              { num: 3, label: 'Telematics Consent' },
